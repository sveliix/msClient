...
public class TSGuiConfig extends GuiScreen{
	...
	public TSGuiConfig(GuiScreen parent) {
	...
	public void initGui() {
		...
		this.btnToggleSneak		= new GuiButton(01,	this.width / 2 - 98,	getRowPos(1), 60, 20, String.valueOf(ToggleSneakMod.optionToggleSneak));
		this.btnToggleSprint	= new GuiButton(02,	this.width / 2 + 102,	getRowPos(1), 60, 20, String.valueOf(ToggleSneakMod.optionToggleSprint));
		this.btnShowHUDText		= new GuiButton(03,	this.width / 2 + 2,		getRowPos(2), 60, 20, String.valueOf(ToggleSneakMod.optionShowHUDText));
		...
		this.btnDoubleTap		= new GuiButton(04,	this.width / 2 + 2,	getRowPos(5), 60, 20, String.valueOf(ToggleSneakMod.optionDoubleTap));
		this.btnFlyBoost		= new GuiButton(05,	this.width / 2 - 113,getRowPos(6), 60, 20, String.valueOf(ToggleSneakMod.optionEnableFlyBoost));
		...
		this.btnOptionsButton	= new GuiButton(06, this.width / 2 + 2, getRowPos(7), 60, 20, ToggleSneakMod.optionButtonPosition == 1 ? "Left" : "Right");

		
		this.btnSaveSettings	= new GuiButton(100, this.width / 2 - 75, footerPos, 150, 20, "Save Settings");
