...
import msClient.gui.GuiCredits;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation msgui = new ResourceLocation("textures/msgui.jpg");
    ...
    public void initGui()
    {
        ...
        }else if (calendar.get(2) + 1 == 4 && calendar.get(5) == 28)
        {
            this.splashText = "Happy Birthday MSES!";
        }else if (calendar.get(2) + 1 == 11 && calendar.get(5) == 18)
        {
            this.splashText = "Happy Birthday Kruemelmomster!";
        }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("ResourcePacks", new Object[0])));
    }
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        for (int j = 0; j < i * i; ++j)
        {
            ...
            for (int k = 0; k < 6; ++k)
            {
                ...
                this.mc.getTextureManager().bindTexture(msgui);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int i2 = width;
		int j2 = height;
        this.drawString(this.fontRendererObj, "", 0, 0, Color.WHITE.getRGB());
		drawModalRectWithCustomSizedTexture(0, 0, 0, 0, 1920, 1080, i2, j2);
        ...
        GlStateManager.popMatrix();
        String s = main.Client_Name + " " + main.Client_Version;
        ...
        String s1 = "by " + main.Client_Coder;
        //this.drawString(this.fontRendererObj, s1, this.width - this.fontRendererObj.getStringWidth(s1) - 2, this.height - 10, -1);
        
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(new Date());
        int p = calendar.get(5);
        int o = calendar.get(2) + 1;
        int q = calendar.get(1);
        Date t = calendar.getTime();
        String s2 = "" + t;
        //this.drawString(this.fontRendererObj, s2, this.width/2 - this.fontRendererObj.getStringWidth(s2)/2 , this.height - 10, -1);
        ...
        int t1 = this.fontRendererObj.getStringWidth("MSClient")/2;
        GL11.glPushMatrix();
		GL11.glScalef(2F, 2F, 2F);
		this.drawString(this.fontRendererObj, "MSClient", Math.round((width/2 - t1 - 12)/2F), Math.round(75/2F), Color.WHITE.getRGB());
		GL11.glPopMatrix();
