...
import msClient.test.togglesneak.gui.TSGuiConfig;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(723, 2, 2, 98, 20, I18n.format("MSClient", new Object[0])));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.enabled)
        {
            ...
            if(button.id == 723) {
            	this.mc.displayGuiScreen(new MSMainMenu(this));
            }
        }
    }
