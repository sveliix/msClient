...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> call()
    {
    	...
    	List<String> list2 =  Lists.newArrayList(new String[] {"MSClient 1.8.8", "", "FPS: "+this.mc.getDebugFPS(),  "X: " + (int)this.mc.getRenderViewEntity().posX , "Y: " + (int)this.mc.getRenderViewEntity().posY , "Z: " + (int)this.mc.getRenderViewEntity().posZ ,  "", String.format("%s ", new Object[]{enumfacing, s, Float.valueOf(MathHelper.wrapAngleTo180_float(entity.rotationYaw)), Float.valueOf(MathHelper.wrapAngleTo180_float(entity.rotationPitch))})});
    ...
    protected List<String> getDebugInfoRight()
    {
        ...
        List<String> list = Lists.newArrayList(new String[] { String.format("Mem: % 2d%% %03d/%03dMB", new Object[]{Long.valueOf(l * 100L / i), Long.valueOf(bytesToMb(l)), Long.valueOf(bytesToMb(i))}), });
