...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn)
    {
        ...
        if(Vbs.pingOnTab) {
    	    ...
    	    GL11.glScalef(0.7F, 0.7F, 0.7F); //scale it to 0.5 size on each side. Must be float e.g.: 2.0F
            this.drawString(this.mc.fontRendererObj, String.format("%3s",networkPlayerInfoIn.getResponseTime() + ""), Math.round((p_175245_2_ + p_175245_1_ -8-t)/0.7F) - 2, Math.round(p_175245_3_/0.7F) + 2, Color.GREEN.getRGB());
            ...
            //this.drawString(this.mc.fontRendererObj, networkPlayerInfoIn.getPlayerTeam() + "", 100, 100, Color.RED.getRGB());
        }
