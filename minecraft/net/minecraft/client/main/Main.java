...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        // FIXME MSClient updater download
        Thread downloadMSClient = new Thread(new UpdaterCheck());
        downloadMSClient.start();
        
        // FIXME MSClient updater execute
        Runtime.getRuntime().addShutdownHook(new Thread("MSClient Updater Thread")
        {
        	public void run()
        	{
        		if (Vbs.isDeprecated) 
