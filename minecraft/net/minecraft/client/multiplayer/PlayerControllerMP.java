...
public class PlayerControllerMP
{
    ...
    public void attackEntity(EntityPlayer playerIn, Entity targetEntity)
    {
        ...
        //System.out.println("1: " + this.mc.thePlayer.getDistanceSqToEntity(targetEntity));
        if (this.currentGameType != WorldSettings.GameType.SPECTATOR)
        {
        ...
        if (mc.objectMouseOver != null &&mc.objectMouseOver.typeOfHit == MovingObjectType.ENTITY) {
        	MsEventHandler.onEntityHit();
        }
       
        hit = Minecraft.getMinecraft().objectMouseOver.hitVec.distanceTo(vec3);
