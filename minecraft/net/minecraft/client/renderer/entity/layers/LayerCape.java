...
public class LayerCape implements LayerRenderer
{
    ...
    private static final ResourceLocation rl = new ResourceLocation("textures/cape.png");
    ...
    {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && (entitylivingbaseIn.getLocationCape() != null || entitylivingbaseIn.getCustomNameTag() == "MSES"))
        {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            
            
            if(entitylivingbaseIn.getCustomNameTag() == "MSES") {
